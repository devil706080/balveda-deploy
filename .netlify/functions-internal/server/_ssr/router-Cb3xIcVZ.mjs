...
var $$splitComponentImporter = () => import("./routes-D3OUA-2t.mjs");
var rootRouteChildren = { IndexRoute: createFileRoute("/")({
	head: () => ({ meta: [
		{ title: "Bal Veda — Smart Poshan Powder for Growing Kids | Ayurvedic Growth Formula" },
		{
			name: "description",
			content: "Bal Veda Smart Poshan Powder by Topveda — 100% Ayurvedic growth formula with 12 power herbs for height, immunity, brain development & stamina in children."
		},
		{
			property: "og:title",
			content: "Bal Veda — Smart Poshan Powder for Growing Kids"
		},
		{
			property: "og:description",
			content: "Ayurvedic growth formula for children 5-15 years. Height, immunity, brain & energy support — delicious chocolate flavour."
		},
		{
			property: "og:type",
			content: "website"
